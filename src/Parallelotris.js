...
(function (lib, img, cjs) {
  ...
  (lib.Prop = function (mode, startPosition, loop) {
    ...
    this.shape_2.graphics
      ...
      .ss(1, 1, 1)
      .p(
        "ABshcIAqATABshcIglgSAgghUIAggcAgghUIglAfAgahFIAggcAgahFIglAfAiVBJIAnAVIAiATAA3AfIghAcIgkAfAAcBMIAggaAAcBMIglAh"
      );
    ...
    this.shape_3.graphics
      ...
      .ss(2, 1, 1)
      .p(
        "ADci8IhsBdAg0iWIAYBAIAGAPIAZBGIBtheAhqBcIhxBhAhqBcIBthdIAWA5IAHASIAVA4"
      );
    ...
    this.shape_4.graphics
      ...
      .s("#000000")
      .ss(1, 1, 1)
      .p("AhYglIAeAqIAWAhABZglIgXAkIgVAg");
    ...
    this.shape_5.graphics
      ...
      .s("#000000")
      .ss(2, 1, 1)
      .p("AhYjmIBfCXIBniSAg8ARIiSDNAg8ARIBDhgIA5BXICPDfAgvBkIBcAAAgvCGIBcAA");
    ...
    this.shape_6.graphics
      ...
      .s("#000000")
      .ss(2, 1, 1)
      .p("AggjsIAACAIDXAAAgghsIAAA7IA7AAIAAgzAgggxIAAEeAi2hsICWAA");
    ...
    this.shape_8.graphics
      ...
      .s()
      .p(
        "Ag2hnQATgLAaABQA/ABAABGQAAAhgSAVQgbAggWAgIA9AAQAcADAAARQAAASgXAAIhqgCQgOgEgEgHQgBgCAAgJQAAgGAug2QArgzAAgVQAAgNgDgGQgFgPgSAAQgKAAgSAJQgRAIgEAAQgTAAACgSQAAgPAVgLIAAAA"
      )
      .cp();
    ...
    this.shape_9.graphics
      ...
      .s()
      .p(
        "AgcgTQgJASgSAjIBHAAQAAg6ACgdIAAgRQgeARgQAiIAAAAAA5heQABACgCA6IAABBIAaAAQAMAAAFAIIADAJQAAAYgugEQAAACAAAUQgEAUgUAAQgbAAABgQQAAgDAKgVIhVAAQgZgGgGgIQgBgCAAgLQA3iYA1AAQAtAAAFAPIAAAA"
      )
      .cp();
    ...
    this.shape_10.graphics
      ...
      .s("#000000")
      .ss(2, 1, 1)
      .p("AjFB/IA9AAIAABGAjLjIIAAGRIGXAA");
    ...
    this.shape_11.graphics
      ...
      .s()
      .p(
        "ABIhCQAAAtgdARQAWAPAHAQQAFALAAAVQAAA8hNACQhMACAAgrQgBgFADgEQAFgLARAAQALAAAJAHQAPANACACIAWAAQANgIALgFQAHgDAAgHQAAgggsgHQgugIAAgPQAAgPArgIQAogJAAgeQAAgDgdgOIggAAQgCADgIAFQgJADgDAAQgSAAAAgUQgBgIAGgHQANgOAnAAQAsAAAYAWQARAQAAAQIAAAA"
      )
      .cp();
    ...
    this.shape_12.graphics
      ...
      .s()
      .p(
        "AgEg+QgiAZgLAAQgNAAgEgJQgCgDAAgEQBDhFATAZQAKALgBAwQAAAlgDAmQgBASgCAOQAwAEAAAQQAAAHgDADQgIAGgVAAQhHAAgSgJQgGgDAAgLQAAgQAvAAQAAgDAAgDQABgWAGgqIAAg6"
      )
      .cp();
    ...
    this.timeline.addTween(
      cjs.Tween.get({})
        ...
        .to({ state: [{ t: this.shape_9 }, { t: this.shape_7 }] }, 1)
        .to({ state: [{ t: this.shape_11 }, { t: this.shape_10 }] }, 1)
        .to({ state: [{ t: this.shape_12 }, { t: this.shape_10 }] }, 1)
        .wait(1)
    );
    ...
    this.shape_13.graphics
      .lf(["#00E2A8", "#33FFFF"], [0, 1], 23.2, -22.6, -23, 22.7)
      .s()
      .p(
        "ADIlEQB9AAAAB9IAAGPQAAB9h9AAImPAAQh9AAAAh9IAAmPQAAh9B9AAIGPAAAETjHQAAhLhLAAImPAAQhLAAAABLIAAGPQAABLBLAAIGPAAQBLAAAAhLIAAmP"
      )
      .cp();

    this.shape_14 = new cjs.Shape();
    this.shape_14.graphics
      .lf(["#00E2A8", "#33FFFF"], [0, 1], -27.4, 0, 27.5, 0)
      .s()
      .p("AETjHIAAGPQAABLhLAAImPAAQhLAAAAhLIAAmPQAAhLBLAAIGPAAQBLAAAABLIAAAA")
      .cp();
  ...
  (lib.Piece = function (mode, startPosition, loop) {
    ...
    this.shape_19.graphics
      ...
      .s("#000000")
      .ss(2, 1, 1)
      .p("ACWiVIAAErIkrAAIAAkrIErAA")
      .cp();

    this.timeline.addTween(
      cjs.Tween.get({})
        .to({ state: [{ t: this.shape_15 }] })
    ...
    this.shape_20.graphics
      .lf(["#FAE2A8", "#FF9966"], [0, 1], -27.4, 0, 27.5, 0)
      .s()
      .p("AETjHIAAGPQAABLhLAAImPAAQhLAAAAhLIAAmPQAAhLBLAAIGPAAQBLAAAABLIAAAA")
      .cp();
    ...
    this.shape_21.graphics
      .lf(["#FAE2A8", "#FF9966"], [0, 1], 23.2, -22.6, -23, 22.7)
      .s()
      .p(
        "AETjHQAAhLhLAAImPAAQhLAAAABLIAAGPQAABLBLAAIGPAAQBLAAAAhLIAAmPADIlEQB9AAAAB9IAAGPQAAB9h9AAImPAAQh9AAAAh9IAAmPQAAh9B9AAIGPAA"
      )
      .cp();

    this.shape_22 = new cjs.Shape();
    this.shape_22.graphics
      .lf(["#FFFA00", "#FFCF00"], [0, 1], 23.2, -22.6, -23, 22.7)
      .s()
      .p(
        "AETjHQAAhLhLAAImPAAQhLAAAABLIAAGPQAABLBLAAIGPAAQBLAAAAhLIAAmPADIlEQB9AAAAB9IAAGPQAAB9h9AAImPAAQh9AAAAh9IAAmPQAAh9B9AAIGPAA"
      )
    ...
    this.shape_23.graphics
      .lf(["#FFFF00", "#FFCC00"], [0, 1], -27.4, 0, 27.5, 0)
      .s()
      .p("AETjHIAAGPQAABLhLAAImPAAQhLAAAAhLIAAmPQAAhLBLAAIGPAAQBLAAAABLIAAAA")
      .cp();
    ...
    this.timeline.addTween(
      cjs.Tween.get({})
        .to({ state: [{ t: this.shape_21 }, { t: this.shape_20 }] })
        .to({ state: [{ t: this.shape_23 }, { t: this.shape_22 }] }, 4)
        .wait(1)
    );
  }).prototype = p = new cjs.MovieClip();
  p.nominalBounds = new cjs.Rectangle(-32.4, -32.4, 65, 65);
  ...
  (lib.Tranforme = function (mode, startPosition, loop) {
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.instance)
        .wait(1)
        .to({ scaleX: 0.96, scaleY: 0.96, alpha: 0.91 }, 0)
        .wait(1)
        .to({ scaleX: 1.43, scaleY: 1.43, alpha: 0.828 }, 0)
        .wait(1)
        .to({ scaleX: 1.88, scaleY: 1.88, alpha: 0.75 }, 0)
        .wait(1)
        .to({ scaleX: 2.3, scaleY: 2.3, alpha: 0.68 }, 0)
        .wait(1)
        .to({ scaleX: 2.7, scaleY: 2.7, alpha: 0.609 }, 0)
        .wait(1)
        .to({ scaleX: 3.07, scaleY: 3.07, alpha: 0.551 }, 0)
        .wait(1)
        .to({ scaleX: 3.42, scaleY: 3.42, alpha: 0.488 }, 0)
        .wait(1)
        .to({ scaleX: 3.74, scaleY: 3.74, alpha: 0.43 }, 0)
        .wait(1)
        .to({ scaleX: 4.04, scaleY: 4.04, alpha: 0.379 }, 0)
        .wait(1)
        .to({ scaleX: 4.31, scaleY: 4.31, alpha: 0.328 }, 0)
        .wait(1)
        .to({ scaleX: 4.56, scaleY: 4.56, alpha: 0.289 }, 0)
        .wait(1)
        .to({ scaleX: 4.79, scaleY: 4.79, alpha: 0.25 }, 0)
        .wait(1)
        .to({ scaleX: 4.99, scaleY: 4.99, alpha: 0.219 }, 0)
        .wait(1)
        .to({ scaleX: 5.17, scaleY: 5.17, alpha: 0.191 }, 0)
        .wait(1)
    );
  }).prototype = p = new cjs.MovieClip();
